<%@ Page Title="" Language="C#" MasterPageFile="~/AppShared/MasterPage/Ambient.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="AmbientHouse.Inicio.ExperienciasBarras.Index" %>
                ...
                <tr>
                    ...
                    <td>
                        <asp:UpdatePanel ID="UpdatePanelGrillaTiposBarras" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:GridView ID="GridViewTiposBarras" runat="server" CssClass="table table-bordered bs-table" AutoGenerateColumns="False" CellPadding="4" EmptyDataText="No se Encontraron Registros" ForeColor="#333333" GridLines="None" Width="100%" OnRowCommand="GridViewTiposBarras_RowCommand" OnPageIndexChanging="GridViewTiposBarras_PageIndexChanging">
