...
{
    /// <summary>
    /// Summary description for PresupuestoClienteCambios1
    /// </summary>
    public class PresupuestoClienteCambios1 : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                if (Presupuestos != null)
                {
                    ...
                    double PrecioTotal = servicio.CalcularValorTotalPresupuestoPorPresupuestoIdPendiente((int)Presupuestos.PresupuestoId);
                    ...
                    if (precioConsolidado < PrecioTotal)
                    {
                        ...
                        pdfFormFields.SetField("TotalConsolidado", formatoNumero(PrecioTotal));
                    }
                    else
                    {
