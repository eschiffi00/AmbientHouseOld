<%@ Page Title="" Language="C#" MasterPageFile="~/AppShared/MasterPage/Ambient.Master" AutoEventWireup="true" CodeBehind="EstablecerCantidadInvitados.aspx.cs" Inherits="AmbientHouse.Presupuestos.EstablecerCantidadInvitados" %>
                                            ...
                                            <td>
                                                ...
                                                <asp:Panel ID="PanelFechaEvento" runat="server" GroupingText="">
                                                    <table style="width: 100%;">
                                                        ...
                                                        <tr>
                                                            <td colspan="4"><asp:Label ID="LabelErrores" runat="server" class="form-control" Width="100%" CssClass="text-center" Font-Bold="True" Font-Size="Medium" ForeColor="#FF3300"></asp:Label></td>
                                                        ...
                                                        <tr>
                                                            <td>&nbsp;</td>
                                                            <td>&nbsp;</td>
                                                            <td> <asp:Button ID="ButtonEstablecer" runat="server" class="btn btn-primary" Text="Aceptar" OnClick="ButtonEstablecer_Click"  /></td>
                                                            <td>
