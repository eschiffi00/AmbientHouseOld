<%@ Page Title="" Language="C#" MasterPageFile="~/AppShared/MasterPage/AmbientHouse.Master" AutoEventWireup="true" CodeBehind="RePresupuestar.aspx.cs" Inherits="AmbientHouse.Presupuestos.RePresupuestar" %>
                                            ...
                                            <td>
                                                ...
                                                <asp:Panel ID="PanelFechaEvento" runat="server" GroupingText="">
                                                    <table style="width: 100%;">
                                                        ...
                                                        <tr>
                                                            <td>Total Organizador:<asp:TextBox ID="TextBoxTotalOrganizador" runat="server" class="form-control" Font-Bold="True" ForeColor="Black" ReadOnly="True" Width="100px"></asp:TextBox>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                            <td>&nbsp;</td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>&nbsp;</td>
                                                            <td>
                                                                <asp:Button ID="ButtonAceptar" runat="server" class="btn btn-primary" Text="Aceptar Represupuestacion" OnClick="ButtonAceptar_Click" />
                                                            </td>
                                                            <td>
                                ...
                                <tr>
                                    <td colspan="3">
                                        <div class="panel-footer">
                                            &nbsp;
                                            <asp:Button ID="ButtonSalir" runat="server" class="btn btn-primary" Text="Salir" OnClick="ButtonSalir_Click" />
                                        </div>
                                    </td>
                                </tr>
                            </table>
