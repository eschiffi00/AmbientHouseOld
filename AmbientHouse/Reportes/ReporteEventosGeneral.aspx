<%@ Page Title="" Language="C#" MasterPageFile="~/AppShared/MasterPage/Ambient.Master" AutoEventWireup="true" CodeBehind="ReporteEventosGeneral.aspx.cs" Inherits="AmbientHouse.Reportes.ReporteEventosGeneral" %>
            ...
            <div class="panel-body">
                <table style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:UpdatePanel ID="UpdatePanelGrillaReporteEventosGenerales" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:GridView ID="GridViewReporteEventosGenerales" runat="server" CssClass="table table-bordered bs-table" CellPadding="4" EmptyDataText="No se Encontraron Registros" ForeColor="#333333" GridLines="None" Width="100%" PageSize="25" AllowPaging="True"  >
