<%@ Page Title="" Language="C#" MasterPageFile="~/AppShared/MasterPage/Ambient.Master" AutoEventWireup="true" CodeBehind="Editar.aspx.cs" Inherits="AmbientHouse.Configuracion.TipoCateringTiempoProductoItem.Editar" %>
            ...
            <td>
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        Agregar/Editar Experiencia Tipo Catering
                    </div>
                    <div class="panel-body">
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td>Tipo Catering:</td>
                                <td>
                                    <asp:DropDownList ID="DropDownListTipoCatering" runat="server" class="form-control" Width="100%">
                                    </asp:DropDownList></td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Tiempo:</td>
                                <td>
                                    <asp:DropDownList ID="DropDownListTiempo" runat="server" class="form-control" Width="100%">
                                    </asp:DropDownList></td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:UpdatePanel ID="UpdatePanelProductos" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="DropDownListProductos" runat="server" class="form-control" AppendDataBoundItems="true" Width="100%" AutoPostBack="True" OnSelectedIndexChanged="DropDownListProductos_SelectedIndexChanged">
                                                <asp:ListItem Value="null">&lt;Seleccione Productos&gt;</asp:ListItem>
                                            </asp:DropDownList>
                                        </ContentTemplate>
                                        <Triggers>
                                ...
                                <td>
                                    <asp:UpdatePanel ID="UpdatePanelCategorias" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                         ...
                                         <Triggers>
                                            <asp:AsyncPostBackTrigger ControlID="DropDownListItmes" EventName="SelectedIndexChanged" />
                                            <asp:AsyncPostBackTrigger ControlID="DropDownListProductos" EventName="SelectedIndexChanged" />
                                        </Triggers>
                                    </asp:UpdatePanel>
                                </td>
                                <td>&nbsp;</td>
