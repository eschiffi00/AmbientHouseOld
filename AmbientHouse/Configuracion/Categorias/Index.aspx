<%@ Page Title="" Language="C#" MasterPageFile="~/AppShared/MasterPage/Ambient.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="AmbientHouse.Configuracion.Categorias.Index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderContent" runat="server">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3>Experiencias Ambientacion</h3>
            <br />
            ...
            <div class="panel-body">
                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td>Locaciones:</td>
                        <td>
                            <asp:DropDownList ID="DropDownListLocaciones" class="form-control" runat="server" AppendDataBoundItems="True" Width="100%" AutoPostBack="true" OnSelectedIndexChanged="DropDownListLocaciones_SelectedIndexChanged">
                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Button ID="ButtonNuevo" runat="server" Text="+Agregar Experiencia Ambientacion" class="btn btn-info" OnClick="ButtonNuevo_Click" />
                                ...
                                <ContentTemplate>
                                    <asp:GridView ID="GridViewAmbientacion" runat="server" CssClass="table table-bordered bs-table" AutoGenerateColumns="False" CellPadding="4" EmptyDataText="No se Encontraron Registros" ForeColor="#333333" GridLines="None" Width="100%" PageSize="25" AllowPaging="True" OnPageIndexChanging="GridViewAmbientacion_PageIndexChanging" OnRowCommand="GridViewAmbientacion_RowCommand" OnRowDataBound="GridViewAmbientacion_RowDataBound">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:HyperLinkField DataNavigateUrlFormatString="~/Configuracion/Categorias/Editar.aspx?Id={0}" ControlStyle-CssClass="btn btn-info" DataNavigateUrlFields="Id" Text="Editar">
