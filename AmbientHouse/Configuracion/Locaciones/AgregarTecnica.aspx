<%@ Page Title="" Language="C#" MasterPageFile="~/AppShared/MasterPage/Ambient.Master" AutoEventWireup="true" CodeBehind="AgregarTecnica.aspx.cs" Inherits="AmbientHouse.Configuracion.Locaciones.AgregarTecnica" %>
                    ...
                    <div class="panel-body">
                        <table style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <h3>
                                        <asp:Label ID="LabelLocacion" runat="server" Text=""></asp:Label></h3>
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    &nbsp;|&nbsp;<asp:Button ID="ButtonQuitar" runat="server" class="btn btn-danger" Text="Quitar" OnClick="ButtonQuitar_Click" /></td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
