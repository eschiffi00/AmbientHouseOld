<%@ Page Title="" Language="C#" MasterPageFile="~/AppShared/MasterPage/AmbientHouse.Master" AutoEventWireup="true" CodeBehind="Editar.aspx.cs" Inherits="AmbientHouse.Configuracion.Parametros.Editar" %>
                    ...
                    <div class="panel-body">
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td><h3>Valor:</h3></td>
                                <td>
                                    <asp:TextBox ID="TextBoxValor" runat="server" class="form-control" Width="200px"></asp:TextBox>
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
