<%@ Page Title="" Language="C#" MasterPageFile="~/AppShared/MasterPage/Ambient.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="AmbientHouse.Configuracion.AmbientacionCI.Index" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderContent" runat="server">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3>Experiencias Ambientacion Corporativo Informal</h3>
            <br />
        </div>
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="GridViewAmbientacion" runat="server" CssClass="table table-bordered bs-table" AutoGenerateColumns="False" CellPadding="4" EmptyDataText="No se Encontraron Registros" ForeColor="#333333" GridLines="None" Width="100%" PageSize="25" AllowPaging="True" OnPageIndexChanging="GridViewAmbientacion_PageIndexChanging" OnRowCommand="GridViewAmbientacion_RowCommand" OnRowDataBound="GridViewAmbientacion_RowDataBound">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:HyperLinkField DataNavigateUrlFormatString="~/Configuracion/AmbientacionCI/Editar.aspx?Id={0}" ControlStyle-CssClass="btn btn-info" DataNavigateUrlFields="Id" Text="Editar">
