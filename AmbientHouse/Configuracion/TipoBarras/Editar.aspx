<%@ Page Title="" Language="C#" MasterPageFile="~/AppShared/MasterPage/Ambient.Master" AutoEventWireup="true" CodeBehind="Editar.aspx.cs" Inherits="AmbientHouse.Configuracion.TipoBarras.Editar" %>
                    ...
                    <div class="panel-body">
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td>Segmento:</td>
                                <td>
                                    <asp:DropDownList ID="DropDownListSegmentos" runat="server" class="form-control">
                                    </asp:DropDownList></td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Duracion:</td>
                                <td>
                                    <asp:DropDownList ID="DropDownListDuracion" runat="server" class="form-control">
                                    </asp:DropDownList></td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Tipo de Barrra:</td>
                                <td>
                                    <asp:DropDownList ID="DropDownListTipoBarra" runat="server" class="form-control">
                                        <asp:ListItem Value="ADULTOS">Adultos</asp:ListItem>
                                        <asp:ListItem Value="MENORES">Menores</asp:ListItem>
                                    </asp:DropDownList></td>
                                <td>&nbsp;</td>
                            </tr>
                        </table>
