<%@ Page Title="" Language="C#" MasterPageFile="~/AppShared/MasterPage/AmbientHouse.Master" AutoEventWireup="true" CodeBehind="Editar.aspx.cs" Inherits="AmbientHouse.Configuracion.PlanesDePagos.Editar" %>
            ...
            <td>
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        Agregar/Editar Planes de Pago<br />
                    </div>
                    <div class="panel-body">
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td><h3>Indice:</h3></td>
                                <td>
                                    <asp:TextBox ID="TextBoxIndice" runat="server" class="form-control" Width="200px"></asp:TextBox>
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
