<%@ Page Title="" Language="C#" MasterPageFile="~/AppShared/MasterPage/Ambient.Master" AutoEventWireup="true" CodeBehind="CargarComanda.aspx.cs" Inherits="AmbientHouse.Administracion.PresupuestosAprobados.CargarComanda" %>
      ...
      <div class="panel panel-success">
                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBoxLayout" runat="server" class="form-control" Width="100%" MaxLength="2000" ReadOnly="true" Height="100px" ></asp:TextBox></td>
                        <td>
                          </td>
