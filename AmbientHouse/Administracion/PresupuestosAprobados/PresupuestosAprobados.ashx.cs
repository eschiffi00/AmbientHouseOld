...
{
    /// <summary>
    /// Summary description for PresupuestosAprobados
    /// </summary>
    public class PresupuestosAprobados : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                ...
                if (Presupuestos != null)
                {
                    ...
                    //using (var htmlWorker = new iTextSharp.text.html.simpleparser.HTMLWorker())
                    //{
                    ...
                    foreach (var item in presupuestoAmbientacion)
                    {
                        ...
                        DomainAmbientHouse.Entidades.Productos pro = serviciosAdministrativas.BuscarProducto((int)item.ProductoId);
