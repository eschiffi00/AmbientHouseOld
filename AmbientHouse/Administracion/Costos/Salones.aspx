<%@ Page Title="" Language="C#" MasterPageFile="~/AppShared/MasterPage/Ambient.Master" AutoEventWireup="true" CodeBehind="Salones.aspx.cs" Inherits="AmbientHouse.Administracion.Costos.Salones" %>
...
<script src="https://cdn.rawgit.com/davidstutz/bootstrap-multiselect/master/dist/js/bootstrap-multiselect.js"
    ...
    <asp:UpdatePanel ID="UpdatePanelSalones" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
                            ...
                            <div class="panel-body">
                                ...
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="DropDownListJornada" CssClass="form-control" runat="server"></asp:DropDownList>
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
