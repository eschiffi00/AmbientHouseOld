<%@ Page Title="" Language="C#" MasterPageFile="~/AppShared/MasterPage/Ambient.Master" AutoEventWireup="true" CodeBehind="Tecnicaupd.aspx.cs" Inherits="AmbientHouse.Configuracion.Productos.Tecnicaupd" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function pageLoad() {
            ...
            $('[id*=DropDownListTipoServicio]').multiselect({
                includeSelectAllOption: true,
                dropRight: true,
                enableFiltering: true
            });
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <asp:ListBox ID="DropDownListTipoServicio" runat="server" SelectionMode="Multiple" class="form-control"></asp:ListBox>
                                                                </div>
                                                                <div>
