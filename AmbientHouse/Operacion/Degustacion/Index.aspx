<%@ Page Title="" Language="C#" MasterPageFile="~/AppShared/MasterPage/Ambient.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="AmbientHouse.Operacion.Degustacion.Index" %>
                            ...
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="GridViewDegustacion" runat="server" CssClass="table table-bordered bs-table" AutoGenerateColumns="False" CellPadding="4" EmptyDataText="No se Encontraron Registros" ForeColor="#333333" GridLines="None" Width="100%" PageSize="25" AllowPaging="True" OnPageIndexChanging="GridViewDegustacion_PageIndexChanging">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:HyperLinkField DataNavigateUrlFormatString="~/Operacion/DegustacionDetalle/Index.aspx?Id={0}" ControlStyle-CssClass="btn btn-danger" DataNavigateUrlFields="Id" Text="Ver Comensales">
