<%@ Page Title="" Language="C#" MasterPageFile="~/AppShared/MasterPage/Ambient.Master" AutoEventWireup="true" CodeBehind="Editar.aspx.cs" Inherits="AmbientHouse.Operacion.Planificacion.Editar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderContent" runat="server">
        ...
        <div class="panel panel-success">
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxObservacionesBarras" runat="server" class="form-control" Width="100%" Height="300px" TextMode="MultiLine" ReadOnly="True"></asp:TextBox></td>
                    <td>&nbsp;</td>
        ...
        <div class="panel panel-success">
            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxBocados" runat="server" class="form-control" Width="100%" ReadOnly="True" Height="200px" TextMode="MultiLine"></asp:TextBox></td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxIslas" runat="server" class="form-control" Width="100%" ReadOnly="True" Height="200px" TextMode="MultiLine"></asp:TextBox></td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxEntrada" runat="server" class="form-control" Width="100%" ReadOnly="True" Height="200px" TextMode="MultiLine"></asp:TextBox></td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxPrincipalAdultos" runat="server" class="form-control" Width="100%" ReadOnly="True" Height="200px" TextMode="MultiLine"></asp:TextBox></td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxPrincipalAdolescentes" runat="server" class="form-control" Width="100%" ReadOnly="True" Height="200px" TextMode="MultiLine"></asp:TextBox></td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxPrincipalMenores" runat="server" class="form-control" Width="100%" ReadOnly="True" Height="200px" TextMode="MultiLine"></asp:TextBox>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxPostreAdultosAdolescentes" runat="server" class="form-control" Width="100%" ReadOnly="True" Height="200px" TextMode="MultiLine"></asp:TextBox></td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxPostreMenores" runat="server" class="form-control" Width="100%" ReadOnly="True" Height="200px" TextMode="MultiLine"></asp:TextBox>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxMesaDulce" runat="server" class="form-control" Width="100%" ReadOnly="True" Height="200px" TextMode="MultiLine"></asp:TextBox></td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxFindeFiesta" runat="server" class="form-control" Width="100%" ReadOnly="True" Height="200px" TextMode="MultiLine"></asp:TextBox></td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxTortaAlegorica" runat="server" class="form-control" Width="100%" ReadOnly="True" Height="200px" TextMode="MultiLine"></asp:TextBox></td>
                    <td>&nbsp;</td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox1PlatosEspecciales" runat="server" class="form-control" Width="100%" ReadOnly="True" Height="200px" TextMode="MultiLine"></asp:TextBox></td>
                    <td>&nbsp;</td>
        ...
        <div class="panel panel-success">
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxObservacionesParticularidades" runat="server" class="form-control" Width="100%" Height="300px" TextMode="MultiLine" MaxLength="2000" ReadOnly="true"></asp:TextBox></td>
                    <td>&nbsp;</td>
        ...
        <div class="panel-body">
            <table style="width: 100%;">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxContactoDireccionProveedoresIngresoLugar" runat="server" class="form-control" Width="700px" ReadOnly="true"></asp:TextBox>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxContactoResponsableLugar" runat="server" class="form-control" Width="700px" ReadOnly="true"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxContactoTelefonoLugar" runat="server" class="form-control" Width="700px" ReadOnly="true"></asp:TextBox>
        ...
        <div class="panel-body">
            <table style="width: 100%;">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxDiaArmadoLogistica" runat="server" class="form-control" Width="150px" ReadOnly="true"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxDiaArmadoSalon" runat="server" class="form-control" Width="150px" ReadOnly="true"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxDiaDesarmadoSalon" runat="server" class="form-control" Width="150px" ReadOnly="True"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="TextBoxCantPersonasAfectadasArmado" runat="server" class="form-control" Width="150px" ReadOnly="True"></asp:TextBox>
        ...
        <div class="panel-body">
            <table style="width: 100%;">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxHoraArmadoLogistica" runat="server" class="form-control" Width="100px" ReadOnly="true"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxHoraArmadoSalon" runat="server" class="form-control" Width="100px" ReadOnly="true"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBoxHoraDesarmadoSalon" runat="server" class="form-control" Width="100px" ReadOnly="True"></asp:TextBox>
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td>
                        <asp:Label ID="LabelHoraArmadoSalon" runat="server" ForeColor="Red" Text="Hora Invalida"></asp:Label>
                    </td>
            ...
            <asp:UpdatePanel ID="UpdatePanelLogistica" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td class="auto-style7">
                                <asp:ImageButton ID="ImageButtonSePidioHielo" runat="server" Width="30px" Height="30px" OnClick="ImageButtonSePidioHielo_Click" />
                            </td>
                            <td>

                                <asp:TextBox ID="TextBoxObservacionesHielo" runat="server" TextMode="MultiLine" CssClass="form-control" Width="100%"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="auto-style7">
                                <asp:ImageButton ID="ImageButtonSePidioMoviliario" runat="server" Width="30px" Height="30px" OnClick="ImageButtonSePidioMoviliario_Click" />
                            </td>
                            <td>
                                <asp:TextBox ID="TextBoxObservacionesMoviliario" runat="server" TextMode="MultiLine" Width="100%" CssClass="form-control"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="auto-style7">
                                <asp:ImageButton ID="ImageButtonSePidioLogitica" runat="server" Width="30px" Height="30px" OnClick="ImageButtonSePidioLogitica_Click" />
                            </td>
                            <td>
                                <asp:TextBox ID="TextBoxObservacionesLogistica" runat="server" TextMode="MultiLine" Width="100%" CssClass="form-control"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style5">
                            ...
                            <td class="auto-style7">
                                <asp:ImageButton ID="ImageButtonManteleria" runat="server" Width="30px" Height="30px" OnClick="ImageButtonManteleria_Click" />
                            </td>
                            <td>
                                <asp:TextBox ID="TextBoxObservacionesManteleria" runat="server" TextMode="MultiLine" Width="100%" CssClass="form-control"></asp:TextBox>
                            </td>
            ...
            <table style="width: 100%;">
                <tr>
                    <td>&nbsp;</td>
                    <td>
                        <asp:Button ID="ButtonGuardarLogistica" runat="server" class="btn btn-primary" Text=" Grabar y Continuar" OnClick="ButtonGuardarLogistica_Click" />
                    </td>
                </tr>
            </table>
    ...
    <div class="panel panel-success">
        ...
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBoxObservacionesTecnica" runat="server" class="form-control" Width="100%" Height="300px" TextMode="MultiLine" MaxLength="2000" ReadOnly="true"></asp:TextBox></td>
    ...
    <div class="panel panel-success">
        ...
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBoxObservacionesAmbientacion" runat="server" class="form-control" Width="100%" Height="300px" TextMode="MultiLine" MaxLength="2000" ReadOnly="true"></asp:TextBox></td>
    ...
    <div class="panel panel-success">
        ...
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBoxObservacionesAdicionales" runat="server" class="form-control" Width="100%" Height="300px" TextMode="MultiLine" MaxLength="2000" ReadOnly="true"></asp:TextBox></td>
    ...
    <div class="panel panel-success">
        ...
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBoxObservacionesOtros" runat="server" class="form-control" Width="100%" Height="300px" TextMode="MultiLine" MaxLength="2000" ReadOnly="true"></asp:TextBox></td>
    ...
    <div class="panel panel-success">
        ...
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBoxLayout" runat="server" class="form-control" Width="100%" MaxLength="2000" ReadOnly="true" Height="300px" TextMode="MultiLine"></asp:TextBox></td>
                <td></td>
        ...
        <table style="width: 100%;">
            ...
            <tr>
                <td colspan="2">
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:DropDownList ID="DropDownListNombreArchivo" runat="server" class="form-control" Width="100%">
                                    <asp:ListItem>PLANILLA EXPEDICION LOGISTICA</asp:ListItem>
                                    <asp:ListItem>COMANDA</asp:ListItem>
                                    <asp:ListItem>PLANILLA PRODUCCION</asp:ListItem>
                                    <asp:ListItem>PLANILLA EXPEDICION COCINA</asp:ListItem>
                                    <asp:ListItem>PLANILLA EXPEDICION BARRA</asp:ListItem>
                                </asp:DropDownList>
                    ...
                    <asp:GridView ID="GridViewArchivo" runat="server" CssClass="table table-bordered bs-table" AutoGenerateColumns="False" CellPadding="4" EmptyDataText="No se Encontraron Registros" ForeColor="#333333" GridLines="None" Width="100%" OnRowCommand="GridViewArchivo_RowCommand" OnRowDataBound="GridViewArchivo_RowDataBound">
    ...
    <p>
        <asp:Button ID="ButtonImprimir" runat="server" class="btn btn-danger" Text="Imprimir" OnClick="ButtonImprimir_Click" />
        &nbsp;|&nbsp;
        <asp:Button ID="ButtonVolver" runat="server" class="btn btn-outline-primary" OnClick="ButtonVolver_Click" Text="Salir" />
