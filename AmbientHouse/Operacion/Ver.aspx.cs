...
namespace AmbientHouse.Operacion
{
    public partial class Ver : System.Web.UI.Page
    {
        ...
        {
            Parametros parametroCateringEntre3y8 = eventos.BuscarParametros("PorcentajeCateringEntre3y8");

            decimal porcentajeCateringEntre3y8 = decimal.Parse(parametroCateringEntre3y8.Valor);

            Parametros parametroCateringMenores3 = eventos.BuscarParametros("PorcentajeCateringMenores3");

            decimal porcentajeCateringMenores3 = decimal.Parse(parametroCateringMenores3.Valor);

            Parametros parametroCateringAdolescentes = eventos.BuscarParametros("PorcentajeCateringAdolescentes");
