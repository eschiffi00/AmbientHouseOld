<%@ Page Title="" Language="C#" MasterPageFile="~/AppShared/MasterPage/AmbientHouse.Master" AutoEventWireup="true" CodeBehind="Editar.aspx.cs" Inherits="AmbientHouse.Organizador.Presupuestos.Editar" %>
                                ...
                                <div class="panel-body">
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            <td></td>
                                            <td>
                                                <h3>Nro Presupuesto:<asp:TextBox ID="TextBoxNroPresupuesto" runat="server" class="form-control" Width="100%" ReadOnly="True"></asp:TextBox>
                                                </h3>
                                            </td>
                                            <td>&nbsp;</td>
                                        </tr>
