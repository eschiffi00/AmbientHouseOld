<%@ Page Title="" Language="C#" MasterPageFile="~/AppShared/MasterPage/AmbientHouse.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="AmbientHouse.Costos.Adicionales.Index" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
         <div class="panel panel-primary">
        <div class="panel-heading">
            <h3>Costos Adicionales</h3><br />
        </div>
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:Button ID="ButtonNuevo" runat="server" class="btn btn-info" Text="+ Agregar Lista de Precios Adicionales" OnClick="ButtonNuevo_Click"  />
                ...
                <tr>
                    ...
                    <td>
                        <asp:UpdatePanel ID="UpdatePanelGrillaCostoAdicionales" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:GridView ID="GridViewCostoAdicionales" runat="server"  CssClass="table table-bordered bs-table" AutoGenerateColumns="False" CellPadding="4" EmptyDataText="No se Encontraron Registros" ForeColor="#333333" GridLines="None" Width="100%" PageSize="25" AllowPaging="True" OnPageIndexChanging="GridViewCostoAdicionales_PageIndexChanging"  >
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="AdicionalDescripcion" HeaderText="Experiencia" SortExpression="AdicionalDescripcion" />
