<%@ Page Title="" Language="C#" MasterPageFile="~/AppShared/MasterPage/AmbientHouse.Master" AutoEventWireup="true" CodeBehind="Editar.aspx.cs" Inherits="AmbientHouse.Costos.Ambientacion.Editar" %>
            ...
            <td>
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        Actualizar Precios/Costos Experiencias de Ambientacion<br />
                    </div>
                    ...
                    <div class="panel-body">
                        <asp:UpdatePanel ID="UpdatePanelGrillaCostoAmbientacion" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:GridView ID="GridViewCostoAmbientacion" runat="server" CssClass="table table-bordered bs-table" AutoGenerateColumns="False" CellPadding="4" EmptyDataText="No se Encontraron Registros" ForeColor="#333333" GridLines="None" Width="100%" PageSize="25">
