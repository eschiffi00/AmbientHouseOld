<%@ Page Title="" Language="C#" MasterPageFile="~/AppShared/MasterPage/AmbientHouse.Master" AutoEventWireup="true" CodeBehind="Editar.aspx.cs" Inherits="AmbientHouse.Costos.Salones.Editar" %>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td>&nbsp;</td>
                                <td>
                                    <asp:Button ID="ButtonAceptar" runat="server" class="btn btn-info" Text="Leer Excel" OnClick="ButtonAceptar_Click" ValidationGroup="Aceptar" />&nbsp;|&nbsp;
                    ...
                    <div class="panel-body">
                        <asp:UpdatePanel ID="UpdatePanelGrillaPrecioSalones" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:GridView ID="GridViewPrecioSalones" runat="server" CssClass="table table-bordered bs-table" AutoGenerateColumns="False" CellPadding="4" EmptyDataText="No se Encontraron Registros" ForeColor="#333333" GridLines="None" Width="100%" PageSize="25">
