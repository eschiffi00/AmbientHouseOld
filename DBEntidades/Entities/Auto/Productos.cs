...
namespace DbEntidades.Entities
{
    public partial class Productos
    {
		...
		public decimal MargenAjuste { get; set; }
		...
		public override string ToString() 
		{
			...
			"MargenAjuste: " + MargenAjuste.ToString() + "\r\n " + 
			"Royalty: " + Royalty.ToString() + "\r\n " + 
			"Margen2: " + Margen2.ToString() + "\r\n " ;
		}
        public Productos()
        {
            Id = -1;
		...
		public static bool CanBeNull(string colName)
		{
			switch (colName) 
			{
				...
				case "MargenAjuste": return true;
				case "Royalty": return false;
				case "Margen2": return true;
