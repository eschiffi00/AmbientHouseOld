...
namespace DbEntidades.Operators
{
   ...
   //         return lista;
   //     }
   //     public static Parametros GetOneByParameter(string campo, string valor)
   //     {
   //         if (!DbEntidades.Seguridad.Permiso("PermisoParametrosBrowse")) throw new PermisoException();
   //         string columnas = string.Empty;
   ...
   //     columnas = columnas.Substring(0, columnas.Length - 2);
   //         DB db = new DB();
   //         DataTable dt = db.GetDataSet("select " + columnas + " from Parametros where  " + campo + " = \'" + valor + "\'").Tables[0];
   //         Parametros Parametros = new Parametros();
   //         if (dt.Rows.Count > 0)
   //         {
   //             foreach (PropertyInfo prop in typeof(Parametros).GetProperties())
   ...
   //         return Parametros;
   //     }
   //     public static List<Parametros> GetAllByParameter(string campo, string valor)
   //         {
   //             if (!DbEntidades.Seguridad.Permiso("PermisoParametrosBrowse")) throw new PermisoException();
   //             string columnas = string.Empty;
   ...
   //             if (tipo == "String")
   //             {
   //                 queryStr = "select " + columnas + " from Parametros where " + campo + " = \'" + valor.ToString() + "\'";
   //             }
   //             else
   //             {
   //                 queryStr = "select " + columnas + " from Parametros where " + campo + " = " + valor.ToString();
