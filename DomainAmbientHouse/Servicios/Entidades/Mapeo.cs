...
namespace DomainAmbientHouse.Entidades
{
    ...
    public partial class ObtenerEventosPresupuestos
    {
        ...
        //ISNULL(P.CantidadInicialInvitados, 0)+ ISNULL(P.CantidadInvitadosAdolecentes, 0) + ISNULL(P.CantidadInvitadosMenores3y8, 0) + ISNULL(P.CantidadInvitadosMenores3, 0) AS CantidadInicialInvitados
    ...
    public partial class PresupuestoPDF
    {
        ...
        public int? CantidadInvitadosMenores3Final { get; set; }
        public int? CantidadInvitadosMenores3y8Final { get; set; }
        public int? CantidadInvitadosAdolecentesFinal { get; set; }
    ...
    public partial class EventosConfirmadosReservadosTODOS
    {
        ...
        public string GetCliente
        {
            get
            {
                if (ApellidoNombre != "")
                {
                    return ApellidoNombre.ToUpper();
                }
                else if (RazonSocial != "")
                {
                    return RazonSocial.ToUpper();
                }
                else
                    return "";
            }
