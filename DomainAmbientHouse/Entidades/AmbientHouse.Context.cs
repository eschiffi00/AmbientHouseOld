...
namespace DomainAmbientHouse.Entidades
{
    ...
    public partial class AmbientHouseEntities : DbContext
    {
        ...
        public DbSet<ItemDetalleProveedor> ItemDetalleProveedor { get; set; }
        public DbSet<ItemDetalleRatio> ItemDetalleRatio { get; set; }
        ...
        public virtual int CorrecionMovimientosPorCuentas(Nullable<int> cuentaId, Nullable<int> movimientoId, Nullable<decimal> correccion)
        {
            ...
            var correccionParameter = correccion.HasValue ?
                new ObjectParameter("Correccion", correccion) :
                new ObjectParameter("Correccion", typeof(decimal));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("CorrecionMovimientosPorCuentas", cuentaIdParameter, movimientoIdParameter, correccionParameter);
        }
        ...
        public virtual int sp_AltaSalones(Nullable<int> locacionId, Nullable<int> sectorId, Nullable<int> anio, Nullable<int> cantidadInvitados, string dia, Nullable<double> costo, Nullable<double> margen)
        {
            var locacionIdParameter = locacionId.HasValue ?
                new ObjectParameter("LocacionId", locacionId) :
                new ObjectParameter("LocacionId", typeof(int));
            ...
            var cantidadInvitadosParameter = cantidadInvitados.HasValue ?
                new ObjectParameter("CantidadInvitados", cantidadInvitados) :
                new ObjectParameter("CantidadInvitados", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_AltaSalones", locacionIdParameter, sectorIdParameter, anioParameter, cantidadInvitadosParameter, diaParameter, costoParameter, margenParameter);
        }
